...
VALUES
(1, '2024-01-01', '2024-01-10', '2024-01-10', 5000, 'Ремонт двигателя', TRUE, 'A123BC', 1),  -- Выполнен раньше срока
(2, '2024-02-01', '2024-02-15', '2024-02-14', 3000, 'Замена тормозов', TRUE, 'A123BC', 1),  -- Выполнен вовремя
(3, '2024-03-01', '2024-03-10', '2024-03-15', 4000, 'Ремонт кузова', TRUE, 'B456CD', 2);  -- Просрочен
